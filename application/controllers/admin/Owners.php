...
/**
 * Owners is Developed by peacekeeper
 *
 * @author peacekeeper
 */
class Owners extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Owners";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "transport_owners";
        ...
        $this->data['image_fields'] = array('aadhar_front_image', "aadhar_back_image", "license_front_image", "license_back_image",
            "pancard_front_image", "pancard_back_image");
    ...
    function index() {
        ...
        foreach ($this->data["list_items"] as $item) {
            $item->aadhar_front_image = OWNERS_UPLOADS_PROOFS . $item->user_id . "/" . $item->aadhar_front_image;
            $item->aadhar_back_image = OWNERS_UPLOADS_PROOFS . $item->user_id . "/" . $item->aadhar_back_image;
            $item->license_front_image = OWNERS_UPLOADS_PROOFS . $item->user_id . "/" . $item->license_front_image;
            $item->license_back_image = OWNERS_UPLOADS_PROOFS . $item->user_id . "/" . $item->license_back_image;
            $item->pancard_front_image = OWNERS_UPLOADS_PROOFS . $item->user_id . "/" . $item->pancard_front_image;
            $item->pancard_front_image = OWNERS_UPLOADS_PROOFS . $item->user_id . "/" . $item->pancard_front_image;
        }
