...
class Site_settings extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['hide_columns_in_list_view'] = array("address","about_site","google_maps","created_at");
        ...
        $this->data['image_fields'] = array('image', "logo", "favicon", "fav_icon","footer_background");
