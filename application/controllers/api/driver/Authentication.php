...
class Authentication extends Api_controller {
    ...
    public function do_login() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = $this->my_model->get_data_row("drivers", ["phone_number" => $phone_number]);
            if (!empty($data)) {
                ...
                if ($data->status == 0) {
                    ...
                    $user_data = $this->check_driver($data->access_token, "id,access_token,user_id,name,phone_number");
                    $arr = [
                        "status" => "valid",
                        "type" => "",
